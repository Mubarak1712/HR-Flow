...
function PageShell({ title, description, actions, children }) {
  return (
    <motion.div
      ...
      className="space-y-6"
    >
      <div className="flex flex-col gap-4 rounded-[32px] border border-slate-200/80 bg-gradient-to-br from-white via-slate-50 to-white p-6 shadow-[0_18px_80px_rgba(15,23,42,0.06)] sm:flex-row sm:items-end sm:justify-between">
        <div>
